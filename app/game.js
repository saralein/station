...
function create() {
  ...
  let pinkTween = game.add.tween(alienPink).to({x: alienPink.x, y: alienPink.y + 0.6}, 800, Phaser.Easing.Quadratic.InOut, true);
  ...
  let yellowTween = game.add.tween(alienYellow).to({x: alienYellow.x, y: alienYellow.y - 0.4}, 800, Phaser.Easing.Quadratic.InOut, true);
  ...
  let greenTween = game.add.tween(alienGreen).to({x: alienGreen.x, y: alienGreen.y + 0.4}, 800, Phaser.Easing.Quadratic.InOut, true);
  ...
  let blueTween = game.add.tween(alienBlue).to({x: alienBlue.x, y: alienBlue.y - 0.4}, 800, Phaser.Easing.Quadratic.InOut, true);
  ...
  let beigeTween = game.add.tween(alienBeige).to({x: alienBeige.x, y: alienBeige.y + 0.4}, 800, Phaser.Easing.Quadratic.InOut, true);
